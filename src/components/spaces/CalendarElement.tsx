    ...
    `}>
      ...
      {data.attachments && data.attachments.length > 0 && (
        <div className="flex flex-col gap-2 mt-1 pl-9">
           <div className="text-[10px] font-semibold uppercase text-default-400 tracking-wider">Allegati</div>
  ...
  return (
    <div className="flex flex-col gap-4 p-4">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-bold text-default-700">Dettagli Evento</h3>
        <div className="flex gap-1">
           <Button 
             ...
             title={localData.displayMode === 'inline' ? "Passa a vista Card" : "Passa a vista Inline"}
           >
      ...
      <div className="flex flex-col gap-3">
        <div className="grid grid-cols-2 gap-2">
           <div className="flex flex-col gap-1">
             <label className="text-[10px] font-semibold uppercase text-default-500">Inizio</label>
             <Input 
               type="datetime-local" 
               size="sm" 
           ...
           <div className="flex flex-col gap-1">
             <label className="text-[10px] font-semibold uppercase text-default-500">Fine</label>
             <Input 
               type="datetime-local" 
               size="sm" 
        ...
        <div className="flex flex-col gap-1">
             <label className="text-[10px] font-semibold uppercase text-default-500">Ricorrenza</label>
        ...
        <div className="flex flex-col gap-1">
             <label className="text-[10px] font-semibold uppercase text-default-500">Note</label>
             <Textarea 
                minRows={2}
                size="sm"
        ...
        <div className="flex items-center justify-between pt-2 border-t border-default-100">
           <span className="text-xs font-medium text-default-600">Completato</span>
           <Switch 
              size="sm" 
